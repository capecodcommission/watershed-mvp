	...
	function(
		...
		************************************/
		...
		var landuseRenderer = new UniqueValueRenderer(landuseSymbol, "LandUseCatExisting")
			landuseRenderer.addValue("RESSINGLEFAM", new SimpleMarkerSymbol().setColor(new Color([122, 182, 245, 255])).setSize("5").setOutline(null), label: "Residential Single Family")
			landuseRenderer.addValue("COMMERCIAL", new SimpleMarkerSymbol().setColor(new Color([255, 255, 0, 255])).setSize("5").setOutline(null), label: "Commercial")
			landuseRenderer.addValue("INDUSTRIAL", new SimpleMarkerSymbol().setColor(new Color([115, 223, 255, 255])).setSize("5").setOutline(null), label: "Industrial")
			landuseRenderer.addValue("OTHERDEV", new SimpleMarkerSymbol().setColor(new Color([107, 181, 123, 255])).setSize("5").setOutline(null), label: "Other Developable")
			landuseRenderer.addValue("OTHERNONDEV", new SimpleMarkerSymbol().setColor(new Color([2197, 0, 255, 255])).setSize("5").setOutline(null), label: "Other Non-Developable")
			landuseRenderer.addValue("RESCONDOAPT", new SimpleMarkerSymbol().setColor(new Color([205, 205, 102, 255])).setSize("5").setOutline(null), label: "Residential Condo/Apartments")
			landuseRenderer.addValue("RESMULTIFAM", new SimpleMarkerSymbol().setColor(new Color([205, 46, 49, 255])).setSize("5").setOutline(null), label: "Residential Multi Family")
			landuseRenderer.addValue("VACANTDEV", new SimpleMarkerSymbol().setColor(new Color([168, 0, 0, 255])).setSize("5").setOutline(null), label: "Vacant Developable Land")
			landuseRenderer.addValue("VACANTNONDEV", new SimpleMarkerSymbol().setColor(new Color([76, 115, 0, 255])).setSize("5").setOutline(null), label: "Vacant Non-Developable Land")
