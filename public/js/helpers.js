...
const addToStack = (treatment_id, icon, techId = null) => {
    let newtreatment = '<li class="technology" data-route="/edit/' + treatment_id + '" data-treatment="' + treatment_id + '" data-techid="' + techId + '">' + '<a href="" title="' + treatment_id +'">' + '<img src="https://www.cch2o.org/assets/icons/SVG/' + icon + '" alt=""></a></li>';
