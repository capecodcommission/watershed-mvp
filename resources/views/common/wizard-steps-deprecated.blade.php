	...
	<section class="row accHorizontal">
		<aside class="accHorizontal__item">
			...
			<article class="acc_cBox">
				...
				<div class="acc_cCont">
					...
					<p><a class="button--cta right" href="{{url('results', session('scenarioid'))}}"
							target="wmvp_results_{{session('scenarioid')}}">View Scenario Summary</a>
					</p>
					<hr>
					<fieldset class="right">
						<p>Want to choose a create a new scenario <br />or select a different embayment? <br /><a
								href="{{url('/')}}" class="button--cta">Start Over</a></p>
					</fieldset>
					...
					<p>For each of these stages, you can select technologies to remove Nitrogen from the embayment. For
						some, you can select the area that will be treated by drawing a polygon on the map. Your
						progress towards the embayment's Target Nitrogen Removal will be displayed in the graph to the
						left. In addition to the overall target, each sub-embayment will have its own individual
						Nitrogen load and target, which you can track using the graphs in the left sidebar.</p>
		...
		<aside class="accHorizontal__item">
			...
			<article class="acc_cBox">
				<div class="acc_cImg">
					<header>
						<h3>Fertilizer</h3><img src="{{$_ENV['CCC_ICONS_SVG'].'Icon_reduction.svg'}}" alt="" width="60"
							style="display: inline;">
					</header>
				</div>
				<div class="acc_cCont">
					<p><a class="button--cta right" href="{{url('results', session('scenarioid'))}}"
							target="wmvp_results_{{session('scenarioid')}}">View Scenario Summary</a></p>
					<hr>
		...
		<aside class="accHorizontal__item">
			...
			<article class="acc_cBox">
				...
				<div class="acc_cCont">
					<p>
						<a class="button--cta right" href="{{url('results', session('scenarioid'))}}"
							target="wmvp_results_{{session('scenarioid')}}">View Scenario Summary</a>
					</p>
					<hr>
					...
					<div class="technology_list">
						...
						<div data-route="/tech/109" class="technology">
							<a>
								<img
									src="{{$_ENV['CCC_ICONS_SVG'].'Icon_StormwaterBioretentionSoilMediaFilters.svg'}}"><br />
		...
		<aside class="accHorizontal__item">
			...
			<label class="backdrop" for="acc-3">
				<!-- <i class="fa fa-times"></i> --></label>
			<article class="acc_cBox">
				<div class="acc_cImg">

					<header>
						<h3>Septic</h3><img src="{{$_ENV['CCC_ICONS_SVG'].'Icon_reduction.svg'}}" alt="" width="60"
							style="display: inline;">
					</header>
				</div>
				<div class="acc_cCont">
		...
		<aside class="accHorizontal__item">
			...
			<label class="backdrop" for="acc-4">
				<!-- <i class="fa fa-times"></i> --></label>
			<article class="acc_cBox">
				<div class="acc_cImg">
					<header>
					...
					<p><a class="button--cta right" href="{{url('results', session('scenarioid'))}}"
						...
						<div class="technology_list">
							<div data-route="/tech/101" class="technology">
								<a>
									<img
										src="{{$_ENV['CCC_ICONS_SVG'].'Icon_SurfaceWaterRemediationWetlands.svg'}}"><br />
		...
		<aside class="accHorizontal__item">
			...
			<label class="backdrop" for="acc-5">
				<!-- <i class="fa fa-times"></i> --></label>
			<article class="acc_cBox">
				<div class="acc_cImg">
					<header>
				...
				<div class="acc_cCont">
					...
					<div class="technology" data-route="/tech/504">
						<a>
							<img src="{{$_ENV['CCC_ICONS_SVG'].'Icon_SurfaceWaterRemediationWetlands.svg'}}"
								alt=""><br />
		...
		<aside class="accHorizontal__item">
			...
			<label class="backdrop" for="acc-6">
				<!-- <i class="fa fa-times"></i> --></label>
			<article class="acc_cBox">
				<div class="acc_cImg">
					<header>
				...
				<div class="acc_cCont">
					<p><span class="remaining"><strong>Nitrogen Remaining to Threshold:</strong> <span></span>kg</span>
					</p>
					<p><a href="{{url('download', session('scenarioid'))}}">Download Results (.xls)</a></p>
					<p><a href="{{url('results', session('scenarioid'))}}" class="button"
							target="wmvp_results_{{session('scenarioid')}}">View detailed results</a></p>
