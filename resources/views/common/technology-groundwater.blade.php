...
<div class="popdown-content" id="app">
	...
	<section class="body">
			...
			<p>
				...
				<input type="range" id="ground-percent" min="{{$tech->Nutri_Reduc_N_Low}}" max="{{$tech->Nutri_Reduc_N_High}}" value="{{$tech->Nutri_Reduc_N_Low}}" v-model="ground_percent"><br> @{{ground_percent}}%
			</p>
			<p>
