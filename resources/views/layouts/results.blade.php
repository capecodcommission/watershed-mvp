							...
							<tbody>
								...
								<tr id="treat_{{$result->TreatmentID}}">
									...
									<td>
										<div class="technology">
											<img src="{{$_ENV['CCC_ICONS_SVG'].$result->technology->icon}}" alt="">
										</div>
									</td>
									...
									<td><?php if ($result->Nload_Reduction > 0) {
										echo '$'.number_format(($result->Cost_Total/$result->Nload_Reduction)/12.46,0,'.',',');} ?>
									</td>
									@endif
								</tr>
								@endforeach
								<tr id="totals">
									...
									<td colspan="2"><strong><?php if ($result->Nload_Reduction > 0) {
										echo '$'.number_format(($scenario_cost/$n_removed)/12.46,0,'.',',');}?></strong>
									</td>
								</tr>
							</tbody>
						</table>
